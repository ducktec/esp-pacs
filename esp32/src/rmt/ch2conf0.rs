...
#[doc = "Field `DIV_CNT` reader - This register is used to configure the frequency divider's factor in channel2."]
...
#[doc = "Field `DIV_CNT` writer - This register is used to configure the frequency divider's factor in channel2."]
...
#[doc = "Field `IDLE_THRES` reader - In receive mode when the counter's value is bigger than reg_idle_thres_ch2 then the receive process is done."]
...
#[doc = "Field `IDLE_THRES` writer - In receive mode when the counter's value is bigger than reg_idle_thres_ch2 then the receive process is done."]
...
#[doc = "Field `MEM_SIZE` reader - This register is used to configure the the amount of memory blocks allocated to channel2."]
...
#[doc = "Field `MEM_SIZE` writer - This register is used to configure the the amount of memory blocks allocated to channel2."]
...
#[doc = "Field `CARRIER_EN` reader - This is the carrier modulation enable control bit for channel2."]
...
#[doc = "Field `CARRIER_EN` writer - This is the carrier modulation enable control bit for channel2."]
...
#[doc = "Field `CARRIER_OUT_LV` reader - This bit is used to configure carrier wave's position for channel2.1'b1:add on low level 1'b0:add on high level."]
...
#[doc = "Field `CARRIER_OUT_LV` writer - This bit is used to configure carrier wave's position for channel2.1'b1:add on low level 1'b0:add on high level."]
...
impl R {
    #[doc = "Bits 0:7 - This register is used to configure the frequency divider's factor in channel2."]
    #[inline(always)]
    pub fn div_cnt(&self) -> DIV_CNT_R {
        DIV_CNT_R::new((self.bits & 0xff) as u8)
    }
    #[doc = "Bits 8:23 - In receive mode when the counter's value is bigger than reg_idle_thres_ch2 then the receive process is done."]
    #[inline(always)]
    pub fn idle_thres(&self) -> IDLE_THRES_R {
        IDLE_THRES_R::new(((self.bits >> 8) & 0xffff) as u16)
    }
    #[doc = "Bits 24:27 - This register is used to configure the the amount of memory blocks allocated to channel2."]
    #[inline(always)]
    pub fn mem_size(&self) -> MEM_SIZE_R {
        MEM_SIZE_R::new(((self.bits >> 24) & 0x0f) as u8)
    }
    #[doc = "Bit 28 - This is the carrier modulation enable control bit for channel2."]
    #[inline(always)]
    pub fn carrier_en(&self) -> CARRIER_EN_R {
        CARRIER_EN_R::new(((self.bits >> 28) & 1) != 0)
    }
    #[doc = "Bit 29 - This bit is used to configure carrier wave's position for channel2.1'b1:add on low level 1'b0:add on high level."]
    #[inline(always)]
...
#[doc = "`reset()` method sets CH2CONF0 to value 0x3110_0002"]
