...
#[doc = "Field `TX_START` reader - Set this bit to start sending data for channel3."]
...
#[doc = "Field `TX_START` writer - Set this bit to start sending data for channel3."]
...
#[doc = "Field `RX_EN` reader - Set this bit to enbale receving data for channel3."]
...
#[doc = "Field `RX_EN` writer - Set this bit to enbale receving data for channel3."]
...
#[doc = "Field `MEM_WR_RST` reader - Set this bit to reset write ram address for channel3 by receiver access."]
...
#[doc = "Field `MEM_WR_RST` writer - Set this bit to reset write ram address for channel3 by receiver access."]
...
#[doc = "Field `MEM_RD_RST` reader - Set this bit to reset read ram address for channel3 by transmitter access."]
...
#[doc = "Field `MEM_RD_RST` writer - Set this bit to reset read ram address for channel3 by transmitter access."]
...
#[doc = "Field `APB_MEM_RST` reader - Set this bit to reset W/R ram address for channel3 by apb fifo access"]
...
#[doc = "Field `APB_MEM_RST` writer - Set this bit to reset W/R ram address for channel3 by apb fifo access"]
...
#[doc = "Field `MEM_OWNER` reader - This is the mark of channel3's ram usage right.1'b1：receiver uses the ram 0：transmitter uses the ram"]
...
#[doc = "Field `MEM_OWNER` writer - This is the mark of channel3's ram usage right.1'b1：receiver uses the ram 0：transmitter uses the ram"]
...
#[doc = "Field `TX_CONTI_MODE` reader - Set this bit to continue sending from the first data to the last data in channel3."]
...
#[doc = "Field `TX_CONTI_MODE` writer - Set this bit to continue sending from the first data to the last data in channel3."]
...
#[doc = "Field `RX_FILTER_EN` reader - This is the receive filter enable bit for channel3."]
...
#[doc = "Field `RX_FILTER_EN` writer - This is the receive filter enable bit for channel3."]
...
#[doc = "Field `RX_FILTER_THRES` reader - in receive mode channel3 ignore input pulse when the pulse width is smaller then this value."]
...
#[doc = "Field `RX_FILTER_THRES` writer - in receive mode channel3 ignore input pulse when the pulse width is smaller then this value."]
...
#[doc = "Field `REF_CNT_RST` reader - This bit is used to reset divider in channel3."]
...
#[doc = "Field `REF_CNT_RST` writer - This bit is used to reset divider in channel3."]
...
#[doc = "Field `IDLE_OUT_LV` reader - This bit configures the output signal's level for channel3 in IDLE state."]
...
#[doc = "Field `IDLE_OUT_LV` writer - This bit configures the output signal's level for channel3 in IDLE state."]
...
#[doc = "Field `IDLE_OUT_EN` reader - This is the output enable control bit for channel3 in IDLE state."]
...
#[doc = "Field `IDLE_OUT_EN` writer - This is the output enable control bit for channel3 in IDLE state."]
...
impl R {
    #[doc = "Bit 0 - Set this bit to start sending data for channel3."]
    #[inline(always)]
    pub fn tx_start(&self) -> TX_START_R {
        TX_START_R::new((self.bits & 1) != 0)
    }
    #[doc = "Bit 1 - Set this bit to enbale receving data for channel3."]
    #[inline(always)]
    pub fn rx_en(&self) -> RX_EN_R {
        RX_EN_R::new(((self.bits >> 1) & 1) != 0)
    }
    #[doc = "Bit 2 - Set this bit to reset write ram address for channel3 by receiver access."]
    #[inline(always)]
    pub fn mem_wr_rst(&self) -> MEM_WR_RST_R {
        MEM_WR_RST_R::new(((self.bits >> 2) & 1) != 0)
    }
    #[doc = "Bit 3 - Set this bit to reset read ram address for channel3 by transmitter access."]
    #[inline(always)]
    pub fn mem_rd_rst(&self) -> MEM_RD_RST_R {
        MEM_RD_RST_R::new(((self.bits >> 3) & 1) != 0)
    }
    #[doc = "Bit 4 - Set this bit to reset W/R ram address for channel3 by apb fifo access"]
    #[inline(always)]
    pub fn apb_mem_rst(&self) -> APB_MEM_RST_R {
        APB_MEM_RST_R::new(((self.bits >> 4) & 1) != 0)
    }
    #[doc = "Bit 5 - This is the mark of channel3's ram usage right.1'b1：receiver uses the ram 0：transmitter uses the ram"]
    #[inline(always)]
    pub fn mem_owner(&self) -> MEM_OWNER_R {
        MEM_OWNER_R::new(((self.bits >> 5) & 1) != 0)
    }
    #[doc = "Bit 6 - Set this bit to continue sending from the first data to the last data in channel3."]
    #[inline(always)]
    pub fn tx_conti_mode(&self) -> TX_CONTI_MODE_R {
        TX_CONTI_MODE_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - This is the receive filter enable bit for channel3."]
    #[inline(always)]
    pub fn rx_filter_en(&self) -> RX_FILTER_EN_R {
        RX_FILTER_EN_R::new(((self.bits >> 7) & 1) != 0)
    }
    #[doc = "Bits 8:15 - in receive mode channel3 ignore input pulse when the pulse width is smaller then this value."]
    #[inline(always)]
    pub fn rx_filter_thres(&self) -> RX_FILTER_THRES_R {
        RX_FILTER_THRES_R::new(((self.bits >> 8) & 0xff) as u8)
    }
    #[doc = "Bit 16 - This bit is used to reset divider in channel3."]
    #[inline(always)]
    ...
    #[doc = "Bit 18 - This bit configures the output signal's level for channel3 in IDLE state."]
    #[inline(always)]
    pub fn idle_out_lv(&self) -> IDLE_OUT_LV_R {
        IDLE_OUT_LV_R::new(((self.bits >> 18) & 1) != 0)
    }
    #[doc = "Bit 19 - This is the output enable control bit for channel3 in IDLE state."]
    #[inline(always)]
...
#[doc = "`reset()` method sets CH3CONF1 to value 0x0f20"]
