...
#[doc = "Field `DIV_CNT` reader - This register is used to configure the frequency divider's factor in channel3."]
...
#[doc = "Field `DIV_CNT` writer - This register is used to configure the frequency divider's factor in channel3."]
...
#[doc = "Field `IDLE_THRES` reader - In receive mode when the counter's value is bigger than reg_idle_thres_ch3 then the receive process is done."]
...
#[doc = "Field `IDLE_THRES` writer - In receive mode when the counter's value is bigger than reg_idle_thres_ch3 then the receive process is done."]
...
#[doc = "Field `MEM_SIZE` reader - This register is used to configure the the amount of memory blocks allocated to channel3."]
...
#[doc = "Field `MEM_SIZE` writer - This register is used to configure the the amount of memory blocks allocated to channel3."]
...
#[doc = "Field `CARRIER_EN` reader - This is the carrier modulation enable control bit for channel3."]
...
#[doc = "Field `CARRIER_EN` writer - This is the carrier modulation enable control bit for channel3."]
...
#[doc = "Field `CARRIER_OUT_LV` reader - This bit is used to configure carrier wave's position for channel3.1'b1:add on low level 1'b0:add on high level."]
...
#[doc = "Field `CARRIER_OUT_LV` writer - This bit is used to configure carrier wave's position for channel3.1'b1:add on low level 1'b0:add on high level."]
...
(https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [ch3conf0]
(index.html) module"]
pub struct CH3CONF0_SPEC;
impl crate::RegisterSpec for CH3CONF0_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [ch3conf0::R]
(R) reader structure"]
impl crate::Readable for CH3CONF0_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [ch3conf0::W]
(W) writer structure"]
impl crate::Writable for CH3CONF0_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets CH3CONF0 to value 0x3110_0002"]
