...
pub struct LOOP_STOP_EN_R(crate::FieldReader<bool, bool>);
impl LOOP_STOP_EN_R {
    #[inline(always)]
    pub(crate) fn new(bits: bool) -> Self {
        LOOP_STOP_EN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for LOOP_STOP_EN_R {
    type Target = crate::FieldReader<bool, bool>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
...
pub struct LOOP_STOP_EN_W<'a> {
    w: &'a mut W,
}
impl<'a> LOOP_STOP_EN_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl W {
    ...
    #[doc = "Bit 21 - This bit is used to enable the loop send stop function after the loop counter counts to loop number for CHANNEL%s."]
    #[inline(always)]
    pub fn loop_stop_en(&mut self) -> LOOP_STOP_EN_W {
        LOOP_STOP_EN_W { w: self }
    }
