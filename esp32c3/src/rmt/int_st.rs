...
#[doc = "Fields `CH(0-1)_TX_END_INT_ST` reader - reg_ch%s_tx_end_int_st."]
pub struct CH_TX_END_INT_ST_R(crate::FieldReader<bool, bool>);
...
#[doc = "Fields `CH(2-3)_RX_END_INT_ST` reader - reg_ch2_rx_end_int_st."]
pub struct CH_RX_END_INT_ST_R(crate::FieldReader<bool, bool>);
...
#[doc = "Fields `CH(0-3)_ERR_INT_ST` reader - reg_ch%s_err_int_st."]
pub struct CH_ERR_INT_ST_R(crate::FieldReader<bool, bool>);
...
#[doc = "Fields `CH(0-1)_TX_THR_EVENT_INT_ST` reader - reg_ch%s_tx_thr_event_int_st."]
pub struct CH_TX_THR_EVENT_INT_ST_R(crate::FieldReader<bool, bool>);
...
#[doc = "Fields `CH(0-1)_TX_LOOP_INT_ST` reader - reg_ch%s_tx_loop_int_st."]
pub struct CH_TX_LOOP_INT_ST_R(crate::FieldReader<bool, bool>);
...
impl R {
    ...
    pub fn ch2_err_int_st(&self) -> CH_ERR_INT_ST_R {
        CH_ERR_INT_ST_R::new(((self.bits >> 6) & 1) != 0)
    }
    #[doc = "Bit 7 - reg_ch3_err_int_st."]
    #[inline(always)]
    pub fn ch3_err_int_st(&self) -> CH_ERR_INT_ST_R {
        CH_ERR_INT_ST_R::new(((self.bits >> 7) & 1) != 0)
    }
